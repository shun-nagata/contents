...
アの場合，複数件の"銀行"が同じ"口座"1件を共有することになる。したがって適していない。

### ヒント2

ウの場合も同様に，複数件の"顧客"が同じ"口座"1件を共有することになる。したがって適していない。

### ヒント3

イの場合，銀行側に外部キーが存在するため，"銀行"対"口座"が多対1となる。これはアと同様であるため，適していない。

エは連関エンティティの説明であり，銀行対顧客の関係性を，複数の口座で表すことができる。したがって，適している。
