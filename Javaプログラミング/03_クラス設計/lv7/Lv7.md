...
インターフェースは、インスタンスが持つ機能を宣言できる。

インターフェースで宣言されたメソッドは、実装クラスにも存在する。
このとき、オーバーライドを用いてメソッドの内容をプログラムする。
...
実装クラスのインスタンスは、インターフェース型の変数から参照できる。
...
サブクラスのインスタンスは、スーパークラス型の変数から参照できる。
